...
var Invoice = (function (Invoice) {
    ...
    //Clear Form
    Invoice.ClearForm = function (form) {
    ...
    //Clear Validation
    Invoice.ClearValidation = function (form) {
    ...
    //Sort Drop Down
    Invoice.SortDropDown = function (selectId) {
    ...
    Invoice.Suppliers = function (list) {
    ...
    //Get Suppliers
    Invoice.GetSuppliers = function (url) {
    ...
    //Get Blank Invoice
    Invoice.GetBlankInvoice = function (url) {
    ...
    //Get Invoice
    Invoice.GetInvoice = function (url) {
    ...
    //Create Invoice
    Invoice.CreateInvoice = function (url) {
    ...
    //Save Invoice
    Invoice.EditInvoice = function (url) {
    ...
    Invoice.DisableEnableSubmit = function (formname) {

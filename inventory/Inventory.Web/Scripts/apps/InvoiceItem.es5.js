...
var InvoiceItem = (function (InvoiceItem) {
    ...
    InvoiceItem.GetAssetCategories = function (url) {
    ...
    //Get Manufacturers
    InvoiceItem.GetManufacturers = function (url) {
        $("#AssetType").change(function () {
            $("#AssetCategory").empty();
            $('#AssetCategory').append($('<option></option>').val(null).html("Please Select"));
            $("#Manufacturer").empty();
    ...
    //Get Products
    InvoiceItem.GetProducts = function (url) {
    ...
    //Get Buildings
    InvoiceItem.GetBuildings = function (url) {
    ...
    //Get Rooms
    InvoiceItem.GetRooms = function (url) {
    ...
    InvoiceItem.InvoiceItemsLicenseTypes = function () {
    ...
    InvoiceItem.InvoiceItemsHardwareSoftware = function () {
        $(document).ready(function () {
    ...
    //Hide Show Defaults
    InvoiceItem.ShowHideDefaults = function (QuantityOriginal) {
    ...
    InvoiceItem.UpdateLocation = function (url) {
